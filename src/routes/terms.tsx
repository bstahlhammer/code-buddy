...
function TermsPage() {
  return (
    <LegalLayout eyebrow="House Rules" title="Terms of Service" updated="April 28, 2026">
      <p>
        Welcome to Wine Flight. By using our web app at apps.forgeproductstrategy.com you agree to
        these Terms. If you don&rsquo;t agree, please don&rsquo;t use the app.
      </p>

      <h2>Who can use Wine Flight</h2>
      <p>
        Wine Flight is intended for adults of legal drinking age in their jurisdiction
      ...
      <p>
        Wine Flight uses AI and statistical models to suggest wines based on your inputs. Suggestions
      ...
      <p>
        ...
        Wine Flight a non-exclusive license to process them solely to provide the service to you
        (e.g., compute your taste profile, run AI analysis on your scan).
      </p>

      <h2>Service availability</h2>
      <p>
        Wine Flight is provided &ldquo;as is&rdquo;. We don&rsquo;t guarantee uninterrupted access,
